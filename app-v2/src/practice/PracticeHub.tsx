...
import { SEED_PRACTICE_CONTENT } from '../storage/data';
...
export function getItemFilter(tab, item) {
...
// MASTERY DOTS
// ─────────────────────────────────────────────────────────────
export function MasteryDots({ streak }) {
  return (
...
// FULL ANSWER CARD
// ─────────────────────────────────────────────────────────────
export function FullAnswerCard({ item, onUpdate, onMarkPracticed }) {
...
// FLASHCARD VIEW
// ─────────────────────────────────────────────────────────────
export function FlashcardView({ item, onKnewIt, onNeedsWork }) {
...
// ─────────────────────────────────────────────────────────────
export function DailyPracticeHub({ data, onClose, onUpdateItem }) {
