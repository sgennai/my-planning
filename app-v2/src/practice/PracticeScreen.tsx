...
// ─── IPLinkedStories ──────────────────────────────────────────────
export function IPLinkedStories({ linkedStoryIds, allStories, onLink, onUnlink }) {
...
// ─── IPRubric ─────────────────────────────────────────────────────
export function IPRubric({ rubric, onChange }) {
  const cur = rubric || {};
...
// ─── IPGlobalSearch ───────────────────────────────────────────────
export function IPGlobalSearch({ questions, stories, categories, onNavigate, onClose }) {
...
// ─── IPCategoryList ───────────────────────────────────────────────
export function IPCategoryList({ ip, selectedId, onSelect, onAdd, onRename, onDelete, onReorder, stats }) {
...
// ─── IPDashboard ──────────────────────────────────────────────────
export function IPDashboard({ stats, onStartRehearsal, onStartMock }) {
...
// ─── IPProgressView ───────────────────────────────────────────────
export function IPProgressView({ ip }) {
  const questions = ip.questions || [];
  const categories = ip.categories || [];
