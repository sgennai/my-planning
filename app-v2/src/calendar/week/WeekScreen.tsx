...
import { parseColorVal, DAY_NAMES_SHORT, DAY_NAMES_LONG, CATEGORY_STYLES, MODULE_STATUS_STYLE } from '../../storage/data';
import { pad, colorValToBackground } from '../../ui/helpers';
import { startOfDay, startOfWeek, addDays, isSameDay, toMinutes, formatDateShort, formatRange, blocksForDate, resolvedRoutineForDate, applyElsewhereFilter, plannedMinutesForProject, combinedDayItems, actionStateMap } from '../../helpers/calendar-utils';
import { BlockPopover } from './BlockPopover';

// RIGHT NOW BANNER
// ═════════════════════════════════════════════════════════════
export function RightNowBanner({ routine, overrides, scheduledBlocks, projects, referenceLibrary, now, onOpenReference, elsewhereToggles, completions }) {
...
// PORTFOLIO PANEL
// ═════════════════════════════════════════════════════════════
export function ProjectsRailPanel({ projects, scheduledBlocks, onCompleteAction, onAddAction, onDeleteAction }) {
...
export function PortfolioPanel({ projects, scheduledBlocks, weekStart }) {
...
export function minutesToHrLabel(min) {
  if (!min) return '0h';
...
export function ProjectCard({ project, expanded, onToggle, scheduledBlocks, weekStart, actionStates }) {
...
// ─────────────────────────────────────────────────────────────
export function ActionChip({ action, project, moduleNumber, actionStates }) {
...
export function ProjectNextActions({ project, actionStates }) {
...
export function NextModulesList({ project, actionStates }) {
...
export function CalendarHeader({ weekStart, weekEnd, isCurrentWeek, dayView, onPrev, onNext, onToday, now, hideTitle }) {
...
export function CalItem({ item, date, hourHeight, projects, onBlockClick, onRoutineClick, onUpdateBlock, onToggleComplete, categoryStyles, now }) {
...
export function NowLine({ now, hourHeight }) {
