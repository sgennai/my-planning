...
import { parseColorVal, CATEGORY_STYLES } from '../../storage/data';
import { pad, colorValToBackground } from '../../ui/helpers';
import { startOfDay, isSameDay, toMinutes } from '../../helpers/calendar-utils';
import { TodayMiniMonth } from './TodayMiniMonth';
...
// TODAY CALENDAR VIEW — single-column hour grid for today
// ═════════════════════════════════════════════════════════════
export function TodayCalendarView({ items, now, viewDate, isToday, lunchSlot, onItemClick, onToggleRoutineComplete, CATS, onDrop, onCreateAtTime, scrollToNowTick }) {
  const HOUR_START = 6;
  const HOUR_END = 23;
