...
export function parseColorVal(v) {
...
export function getCategoryColor(category, userColors) {
...
export function getCategoryEmoji(category, userEmojis) {
...
export function categoryStylesWith(userColors, userEmojis, userLabels, userCategories) {
  const out = {};
...
export const GYM_BAG_CONTENTS = 'Shoes · socks · shorts/jogging · t-shirt · sweater · water bottle with electrolytes';
export const WORK_BAG_CONTENTS = '2 laptops · mouse · cables · AirPods · watch';
...
export const MODULE_STATUS_STYLE = {
...
export const CATEGORY_OPTIONS = ['supplement', 'focus', 'gym', 'review', 'planning', 'prep', 'elsewhere', 'commute'];

// ─────────────────────────────────────────────────────────────
// WEEKLY RESET PHASES — ported from ceo-weekly-reset.jsx
// 5 phases, ~20 minutes total. Friday 15:00–15:30 ritual.
// ─────────────────────────────────────────────────────────────
export const WEEKLY_RESET_PHASES = [
  {
    id: 'pulse',
    label: 'I. PULSE CHECK',
    duration: 120,
...
export const WEEKLY_RESET_TOTAL_SECONDS = WEEKLY_RESET_PHASES.reduce((a, p) => a + p.duration, 0);

// ─────────────────────────────────────────────────────────────
// SEED REFERENCE LIBRARY — quick-access reference content.
// Each entry is a static text reference, editable by the user.
// ─────────────────────────────────────────────────────────────
export const SEED_REFERENCE_LIBRARY = [
  {
...
// ─────────────────────────────────────────────────────────────
export const SEED_PRACTICE_CONTENT = {
  interviewPrep: [
...
// ═════════════════════════════════════════════════════════════
export const SEED_INTERVIEW_CATEGORIES = [
...
export function _ipq(id, catId, q) {
