...
import { parseColorVal, DAY_NAMES_SHORT, DAY_NAMES_LONG, CATEGORY_STYLES, EMOJI_LIBRARY, CATEGORY_OPTIONS } from '../storage/data';
import { pad, ColorPickerExtended } from '../ui/helpers';
import { startOfDay, startOfWeek, addDays, isSameDay, toMinutes, formatDateShort, describeDays, blocksForDate, makeOverrideKey, resolvedRoutineForDate, applyElsewhereFilter } from '../helpers/calendar-utils';
import { RoutineItemPopover } from './RoutineItemPopover';

// AGENDA VIEW (mobile)
// ═════════════════════════════════════════════════════════════
export function AgendaView({ routine, overrides, scheduledBlocks, projects, weekStart, now, onBlockClick, onRoutineClick, elsewhereToggles, icsOccurrences, completions, onToggleComplete, categoryStyles }) {
...
// ═════════════════════════════════════════════════════════════
export function ReferenceLibraryModal({ entries, expandedId, onChangeExpanded, onClose, onUpdate }) {
...
// ═════════════════════════════════════════════════════════════
export function EmojiPickerPopover({ currentEmoji, onPick, onClose }) {
...
export function RoutineManagerModal({ routine, onClose, onUpdateItem, onAddItem, onDeleteItem,
...
export function RoutineEditForm({ item, isNew, onCancel, onSave, onDelete, onCloseModal, embedded = false }) {
